...
rings x = f x :#: p :#: f x :#: p :#: f x :#: p :#: f x
        where
          f 0 = Go 5
          f x = GrabPen yellow :#: f (x-1) :#: GrabPen white :#: f (x-1) :#: p :#: f (x-1) :#: p :#: GrabPen yellow :#: f (x-1) :#: p :#: GrabPen yellow :#: f (x-1) :#: p :#: GrabPen snowblue :#: f (x-1) :#: p :#: GrabPen white :#: f (x-1) :#: n :#: GrabPen yellow :#: f (x-1)
          p = Turn 90
          n = Turn (-90)
